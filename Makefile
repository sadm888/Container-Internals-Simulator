...
SRCS = src/main.c src/container.c src/image.c src/logger.c src/namespace.c src/filesystem.c src/resource.c src/scheduler.c src/network.c src/monitor.c src/bridge.c src/security.c
OBJS = $(SRCS:.c=.o)
